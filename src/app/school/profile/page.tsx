        ...
        <div className="animate-fade-in" style={{
          ...
          <div style={{ padding: '24px 28px', display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: '200px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '4px' }}>{school?.name || 'SD Binaan'}</h2>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
                <span style={S.badge('#3b82f6')}>Gugus {school?.gugus || '-'}</span>
                <span style={S.badge('#10b981')}>{school?.level || 'SD'}</span>
            ...
            <div style={{ flexShrink: 0 }}>
              {school && <SchoolSocialMedia school={school} variant="compact" />}
            </div>
          </div>
        </div>

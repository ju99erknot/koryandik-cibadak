...
export default function PgriDashboard() {
  ...
  usePresence(user, '/pgri/dashboard');
  ...
  return (
    ...
    <DashboardShell
      user={user}
      onLogout={logout}
      headerTitle="Dashboard Ketua PGRI"
        ...
        <div className="content-area">
          ...
          <div className="card animate-fade-in">
            <div className="card-header">
              <h2><i className="fa-solid fa-chart-line" aria-hidden="true"></i> Progres Rekapitulasi PGRI</h2>
            ...
            <div className="card-body">
              ...
              <p style={{ fontSize: '13px', opacity: 0.7 }}>
                {totalApproved} dari {submissions.length} total berkas terkirim telah disetujui koordinator tingkat gugus.
              </p>
            </div>
          </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={guguses.map(g => {
                    ...
                    return { name: `Gugus ${g.id}`, progres: pct };
                  })}
                      ...
                      return (
                        <tr key={school.npsn}>
                          ...
                          <td>
                            ...
                            <br />
                            <small style={{ opacity: 0.6 }}>Operator: {school.operatorName}</small>
                          </td>
                          <td><code>{school.npsn}</code></td>
                          <td><span className="badge badge-pending">Gugus {school.gugus}</span></td>
                          <td>
                            <div className="progress-bar" style={{ width: '100px', display: 'inline-block', marginRight: '8px' }}>
                              <div

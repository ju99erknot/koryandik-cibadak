...
export default function AdminSchools() {
  ...
  return (
    ...
    <DashboardShell
      user={user}
      onLogout={logout}
      headerTitle="Data Sekolah Binaan"
      headerSubtitle="Daftar 49 SD se-Kecamatan Cibadak"
      ...
      {(editingSchool || isAddModalOpen) && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 'var(--z-modal)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div 
            ...
            style={{ position: 'absolute', inset: 0, background: 'var(--modal-backdrop)', backdropFilter: 'blur(var(--modal-blur))', WebkitBackdropFilter: 'blur(var(--modal-blur))' }} 
          />
          <div 

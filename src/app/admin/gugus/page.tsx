          ...
          <div className="stats-grid">
            <div className="stat-card animate-fade-in">
              ...
              <div className="stat-info">
                <span className="stat-label">Total Gugus</span>
                <span className="stat-value">{guguses.length.toLocaleString('id-ID')}</span>
              </div>
            </div>
            <div className="stat-card animate-fade-in">
            ...
            <div className="stat-card animate-fade-in">
              ...
              <div className="stat-info">
                <span className="stat-label">Sekolah Koordinator</span>
                <span className="stat-value">{guguses.filter(g => schools.some(s => s.npsn === g.sekolahInti)).length.toLocaleString('id-ID')}</span>
              </div>
            </div>
          </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '2px' }}>
                          <i className="fa-solid fa-star" style={{ color: 'var(--warning)', marginRight: '4px' }} aria-hidden="true"></i>
                                  ...
                                  <td>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                      {s.npsn === g.sekolahInti && (
                                        <i className="fa-solid fa-crown" style={{ color: 'var(--warning)', fontSize: '14px' }} title="Sekolah Koordinator" aria-hidden="true"></i>
                                      )}
                                  ...
                                  <td>
                                    ...
                                    {s.ksPhone && (
                                      <a
                                        ...
                                        style={{ fontSize: '11px', color: 'var(--success)', display: 'inline-flex', alignItems: 'center', gap: '4px', marginTop: '4px', fontWeight: 600 }}
                                      >
          ...
          >
            ...
            <div className="card-body" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <FancySelect
                ...
                onChange={(val) => {
                  setSelectedKoordinator(val);
                  if (val) setGugusPasscode(val);
                }}
                ...
                return (
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                      <i className="fa-solid fa-crown" style={{ color: 'var(--warning)', fontSize: '16px' }} aria-hidden="true"></i>

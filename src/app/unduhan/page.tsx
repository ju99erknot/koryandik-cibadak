              ...
              {loading ? (
                Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="dlhub-card" style={{ minHeight: '320px', pointerEvents: 'none' }}>
                    <div className="content-skeleton" style={{ height: '120px' }} />
                    <div style={{ padding: '18px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                      <div className="content-skeleton" style={{ height: '12px', width: '60%', borderRadius: '6px' }} />
                      <div className="content-skeleton" style={{ height: '16px', width: '90%', borderRadius: '6px' }} />
                      <div className="content-skeleton" style={{ height: '12px', width: '80%', borderRadius: '6px' }} />
                      <div className="content-skeleton" style={{ height: '12px', width: '70%', borderRadius: '6px' }} />
                    </div>
                  </div>
                ))

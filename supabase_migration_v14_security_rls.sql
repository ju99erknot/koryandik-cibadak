...
DROP POLICY IF EXISTS "public_read" ON schools;
DROP POLICY IF EXISTS "public_read" ON gugus;
DROP POLICY IF EXISTS "public_read" ON supervisors;
...
DROP POLICY IF EXISTS "public_update" ON submissions;

DROP POLICY IF EXISTS "public_read"   ON audit_logs;
DROP POLICY IF EXISTS "public_insert" ON audit_logs;

DROP POLICY IF EXISTS "public_read"   ON notifications;
DROP POLICY IF EXISTS "public_insert" ON notifications;
DROP POLICY IF EXISTS "public_update" ON notifications;
